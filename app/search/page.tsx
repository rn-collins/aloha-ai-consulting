...
export default function Search(){return <SiteShell><main id="main"><section className="page-hero wrap"><p className="kicker">Search · public index</p><h1>Find current public records <em>in plain language.</em></h1><p className="lede">This hand-maintained directory includes usable releases, developing materials, inactive concepts, and operating boundaries at their stated public status. Private records, superseded content, and unpublished drafts are excluded.</p></section><PublicSearch/></main></SiteShell>}
