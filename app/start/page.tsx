...
const choices=[
 ...
 ["06","I want guided learning with Aloha AI","Review the planned free masterclass and the operating conditions that must be complete before registration opens.","/learning/masterclass","Review the masterclass"],
