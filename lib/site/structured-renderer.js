...
<body class="${resource.pathname === '/' ? 'is-home' : resource.pathname === '/services' ? 'is-services' : resource.pathname === '/builds' ? 'is-builds' : resource.pathname === '/university' ? 'is-university' : ''}" data-resource-id="${escapeHtml(resource.id)}" data-resource-kind="${escapeHtml(resource.kind)}" data-maturity="${escapeHtml(resource.maturity)}">
...
${['/', '/services', '/builds', '/university', '/methods', '/about'].includes(resource.pathname) ? '' : identity(resource)}
${prioritySections(resource)}
${resource.pathname === '/services' ? servicesDepth(resource) : resource.pathname === '/builds' ? buildsDepth(resource) : resource.pathname === '/university' ? universityDepth(resource) : editorial(resource)}
${kindSections(resource, registry)}
${evidence(resource)}
${method(resource)}
${governance(resource)}
${['/builds', '/university'].includes(resource.pathname) ? '' : relatedSections(related)}
${cta(resource)}
</main>
...
<div class="university-cover__note">No gate.<br><strong>Just start ↗</strong></div>
  ...
  return `<section class="page-hero section--ink${isHome ? ' page-hero--home' : isServices ? ' page-hero--services' : isBuilds ? ' page-hero--builds' : isUniversity ? ' page-hero--university' : ''}"><div class="wrap page-hero__inner">
