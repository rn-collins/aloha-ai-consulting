...
<p class="detail-cover__issue">${r.kind === 'monitor' ? 'LIVE SIGNAL DESK' : r.kind === 'tool' ? 'TOOL RECORD' : r.kind === 'assessment' ? 'ASSESSMENT RECORD' : 'RESEARCH FILE'} · ${escapeHtml(maturityLabel(r.maturity))}</p>
