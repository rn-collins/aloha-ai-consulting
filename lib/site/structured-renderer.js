...
${['/', '/services', '/builds', '/university', '/university/contact', '/methods', '/about'].includes(resource.pathname) ? '' : identity(resource)}
${prioritySections(resource)}
${resource.pathname === '/services' ? servicesDepth(resource) : resource.pathname === '/builds' ? buildsDepth(resource) : resource.pathname === '/university' ? universityDepth(resource) : resource.pathname === '/university/contact' ? '' : editorial(resource)}
${['/', '/university/contact'].includes(resource.pathname) ? '' : kindSections(resource, registry)}
${['/', '/university/contact'].includes(resource.pathname) ? '' : evidence(resource)}
${['/', '/university/contact'].includes(resource.pathname) ? '' : method(resource)}
${['/', '/university/contact'].includes(resource.pathname) ? '' : governance(resource)}
${['/', '/builds', '/university', '/university/contact'].includes(resource.pathname) ? '' : relatedSections(related)}
...
<div class="contact-cover__reply">RN reads it.<br><strong>A human replies. ↗</strong></div>
  ...
  return `<section class="page-hero section--ink${isHome ? ' page-hero--home' : isServices ? ' page-hero--services' : isBuilds ? ' page-hero--builds' : isUniversity ? ' page-hero--university' : isContact ? ' page-hero--contact' : ''}"><div class="wrap page-hero__inner">
