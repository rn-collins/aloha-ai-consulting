...
<div class="service-hero-map__inputs">
<span>Scattered research</span><span>Repeated work</span><span>High-stakes decisions</span>
</div>
<div class="service-hero-map__connector" aria-hidden="true"><i></i><i></i><i></i></div>
<div class="service-hero-map__core"><span>Clear roles</span><strong>People<br><i>+</i> AI</strong><span>Visible rules</span></div>
<div class="service-hero-map__output"><span>One working system</span><strong>Usable · checkable · current</strong></div>
</div>` : '';
  return `<section class="page-hero section--ink${isHome ? ' page-hero--home' : isServices ? ' page-hero--services' : ''}"><div class="wrap page-hero__inner">
