...
<body class="${resource.pathname === '/' ? 'is-home' : resource.pathname === '/services' ? 'is-services' : resource.pathname === '/builds' ? 'is-builds' : ''}" data-resource-id="${escapeHtml(resource.id)}" data-resource-kind="${escapeHtml(resource.kind)}" data-maturity="${escapeHtml(resource.maturity)}">
...
${resource.pathname === '/builds' ? '' : priorityCollection(resource, registry)}
${engagementPortfolio(resource)}
${['/', '/services', '/builds', '/methods', '/about'].includes(resource.pathname) ? '' : identity(resource)}
${prioritySections(resource)}
${resource.pathname === '/services' ? servicesDepth(resource) : resource.pathname === '/builds' ? buildsDepth(resource) : editorial(resource)}
${kindSections(resource, registry)}
${evidence(resource)}
${method(resource)}
${governance(resource)}
${resource.pathname === '/builds' ? '' : relatedSections(related)}
${cta(resource)}
</main>
...
<div class="builds-cover__count">11<small>ways in</small></div>
  ...
  return `<section class="page-hero section--ink${isHome ? ' page-hero--home' : isServices ? ' page-hero--services' : isBuilds ? ' page-hero--builds' : ''}"><div class="wrap page-hero__inner">
