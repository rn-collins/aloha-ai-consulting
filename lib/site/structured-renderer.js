...
${resource.pathname === '/university/contact' ? '' : kindSections(resource, registry)}
${resource.pathname === '/university/contact' ? '' : evidence(resource)}
${resource.pathname === '/university/contact' ? '' : method(resource)}
${resource.pathname === '/university/contact' ? '' : governance(resource)}
${['/builds', '/university', '/university/contact'].includes(resource.pathname) ? '' : relatedSections(related)}
${resource.pathname === '/university/contact' ? '' : cta(resource)}
</main>
