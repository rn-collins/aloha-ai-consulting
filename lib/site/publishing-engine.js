...
function searchIndex(resources) { return resources.map((r) => ({ id:r.id, title:r.title, summary:r.summary, pathname:r.pathname, kind:r.kind, maturity:r.maturity, topics:r.topics||[], audience:r.audience||null, audiences:audienceTerms(r), industries:r.industries||[], keywords:[...(r.keywords||[]),...(r.synonyms||[])], text:[r.title,r.summary,r.audience||'',...(r.topics||[]),...audienceTerms(r),...(r.industries||[]),...(r.keywords||[]),...(r.synonyms||[])].join(' ').toLowerCase() })); }
