...
const KINDS = ['service','product','tool','monitor','research','build','learningHub','course','lesson','playbook','template','toolGuide','useCase','collection','assessment'];
